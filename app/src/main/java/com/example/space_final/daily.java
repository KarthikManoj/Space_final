...
public class daily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner2 = findViewById(R.id.two);
        ...
        Spinner spinner3 = findViewById(R.id.three);
        ...
        Spinner spinner4 = findViewById(R.id.four);
        ...
        Spinner spinner5 = findViewById(R.id.five);
